    ...
    return (
      <section className="microverse-section-container">
        <div className="microverse-information" data-aos="fade-right">
          ...
          <p className="microverse-description">Developed skills in remote pair-programming using <a href="https://github.com/AbuTalha3/" target="_blank" rel="noreferrer">GitHub</a>, industry-standard gitflow, and daily standups to communicate and collaborate with international remote developers.</p>
